	...
	return (
		<>
			<g transform={`translate(${componentpos.x}, ${componentpos.y})`}>
				...
				>
					<circle className="rating-circle-stroke" cy="8" r="38" />
					<circle className="rating-circle" cx="-10" cy={18} r="38" />
					<text
				...
				<svg xmlns="http://www.w3.org/2000/svg" x={10} y="50">
				...
				<svg xmlns="http://www.w3.org/2000/svg" x={20} y="75">
					<g
				...
				<svg xmlns="http://www.w3.org/2000/svg" x={10} y="150">
					<g className="item" transform="translate(3, 2)">
						<svg
							width="16"
							height="16"
					...
					<g
						id="pull_requcomponents/MyComponentests"
						className="item"
						transform="translate(25, 15)"
					>
						<text className="contribution-stats" x="0" y="0">
				...
				<svg xmlns="http://www.w3.org/2000/svg" x={10} y="175">
					<g className="item" transform="translate(3, 2)">
						<svg
							width="16"
							height="16"
